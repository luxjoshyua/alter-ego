...
// here we remove the sale flash on our individual products in the product loop
remove_action('woocommerce_before_shop_loop_item_title', 'woocommerce_show_product_loop_sale_flash', 10); 

// here we remove the sale flash on our individual products on the product page itself
...
// removes the select an option option, so when on product you go to select colour and size, it doesn't say 'select an option'
